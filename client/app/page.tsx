      ...
      <nav className="fixed w-full z-50 bg-white/80 backdrop-blur-md border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium uppercase tracking-widest">
            ...
            <a href="#nosotros" className="hover:text-orange-700 transition">
              Nosotros
            </a>
            <a href="#menu" className="hover:text-orange-700 transition">
              Menú
            </a>
            <a href="#contacto" className="hover:text-orange-700 transition">
              Ubicación
            </a>
          </div>
          <button className="bg-orange-900 text-white px-5 py-2 rounded-full text-sm font-bold hover:bg-orange-800 transition">
            ORDENAR AQUÍ
          </button>
        </div>
      </nav>
      ...
      <footer className="bg-white border-t border-stone-200 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-stone-400 text-sm">
          <div className="text-center md:text-left">
            <span className="text-xl font-serif font-bold text-orange-900 block mb-2">
              Casa Mango 🥭
            </span>
